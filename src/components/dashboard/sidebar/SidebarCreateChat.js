...
const SidebarCreateChat = () => {
  return (
    <div>
      <div style={{ backgroundColo: "white" }} class="d-flex flex-column h-100">
        <div  class="hide-scrollbar">
          <div style={{ backgroundColo: "white" }}  class="container py-8">
            {/* <!-- Title --> */}
            <div  class="mb-8">
            ...
            {/* <!-- Tabs content --> */}
            <div style={{ backgroundColo: "white" }} class="tab-content" role="tablist">
              <div
        ...
        {/* <!-- Button --> */}
        <div style={{ backgroundColo: "white" }} class="container mt-n4 mb-8 position-relative">
          <button
